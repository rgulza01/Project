...
### by: Radia Gulzan
A monolithic web application to help celiac people form a community where they can share gluten free recipees and stories about their gluten free life. Technologies utilised include: Azure database, Azure VM, Jenkins, Docker, Docker-compose, Docker-Swarm.
